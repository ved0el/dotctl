...
> **Early release (`v0.3.1`).** Core install/link/package flow is stable and
...
curl -fsSL https://raw.githubusercontent.com/ved0el/dotctl/main/install.sh | DOTCTL_VERSION=v0.3.1 sh
